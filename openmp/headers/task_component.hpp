...
public:
   ...
   score_t search(info inf);
   typedef hpx::actions::result_action1<
      server, score_t, search_func_code , info, &server::search
   > search_action;

};
}
HPX_REGISTER_ACTION_DECLARATION_EX(A::server::cancel_action,action_cancel);
HPX_REGISTER_ACTION_DECLARATION_EX(A::server::search_action,action_search);
...
public:
   ...
   static hpx::lcos::future<score_t> search_async(
      hpx::naming::id_type gid, info arg0)
   {
