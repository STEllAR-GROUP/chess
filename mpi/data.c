...
/* The principle variation array
   where the moves are stored
   for the move to parallelism, this can be global
   for each leaf of the tree and will be stores in some sort of
...
int tot_nodes = 0; //Total nodes searched
