...
void gen_random_board(board_t *board, int *side)
{
	//TODO: Implement this function by either generating random board sets or 
	//reading them from a file and randomnly picking one.
